                ...
                .withOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        if (drawerItem instanceof Nameable) {
                            ...
                            String drawerItemName = ((Nameable) drawerItem)
                                    .getName()
                                    .getText(MiniDrawerActivity.this);

                            String msg = " drawerItem: " + drawerItemName;
                            msg += "\n position: " + position;

                            int drawerItemIdentifier = drawerItem.getIdentifier();

                            Toast.makeText(
                                    MiniDrawerActivity.this,
                                    drawerItemName,
                                    Toast.LENGTH_SHORT
                            ).show();
